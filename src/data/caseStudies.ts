...
export const caseStudies: CaseStudy[] = [
  {
    ...
    detail: {
      problem:
        "반복 구조로 인해 플레이어들의 피로감을 높이는 비주얼 노벨을 만들고 싶지 않았습니다. 또한 선택 결과가 엔딩에서만 드러나면, 플레이어는 중간 선택의 의미를 체감하기 어렵습니다.",
      designIntent:
        "매일 달라지는 오브젝트와 선택에 따른 즉각적인 결과를 시간 단위로 분류하여, 플레이어들의 선택이 마지막까지 이어지는 시스템을 설계하였습니다.",
      solution: [
        "하루를 낮 탐색 → 오후 메인 선택 → 밤 결과 회수로 나누었습니다.",
        "네 가지 성향을 분류하여,(회피 / 자책 / 돌봄 / 직면) 선택지의 성향을 명확하게 분류하였습니다.",
        "각 선택지에 따른 선택은, 우울감, 슬픔, 행복, 자신감, 건강, 플래그 등으로 다시 구분하여, 플레이어들과 캐릭터에게 영향을 주도록 설계했습니다.",
      ],
      implementation: [
        "Google Sheets로 Day, 오브젝트, 선택지, 스탯 변화, 플래그, 결과 대사를 분리 관리했습니다.",
        "본 개발 전 HTML 프로토타입을 제작해 UI 흐름과 선택지 구조를 검증했습니다.",
      ],
      result: [
        "PlayX4 전시.",
